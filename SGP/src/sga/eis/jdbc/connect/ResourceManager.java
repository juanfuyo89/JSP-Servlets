...
/**
 * Clase encargada de administrar los recursos de conexión a la BD
 * 
...
public class ResourceManager {
    ...
    /**
     * Metodo que retorna una conexión del Pool
     * 
     * @return Connection
     * @throws SQLException
     */
    ...
    /** 
     * Método que retorna un DataSource considerando valores de un pool de
     * conexiones
     * 
     * @return DataSource
     */
    private static DataSource getDataSource() {
        ...
        // Definimos el tamaÃ±o del pool de conexiones
    ...
    /**
     * Método para carga los valores de la conexion a BD desde un archivo de
     * propidades
     * 
     * @param file
     * @return Properties
